...
5. **Keep `docs/using/basic-functionality.md` up to date** whenever a new built-in action type is added to the launcher (currently: `open_url`, `paste_text`, `copy_text`). Add a dedicated section covering the YAML schema, a minimal example, any parameter behaviour, and platform-specific requirements.
